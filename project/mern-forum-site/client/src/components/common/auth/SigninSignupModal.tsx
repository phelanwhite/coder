...
const SigninSignupModal: FC<Prop> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="z-50 fixed top-0 left-0 bottom-0 right-0 bg-black/40 transition">
      <div
        onClick={onClose}
        ...
        <div className="signin-signup-show-modal relative rounded-2xl max-w-[540px] max-h-full w-full bg-white">
          ...
          <div className="relative max-w-[400px] w-full mx-auto p-4 md:p-7 overflow-y-auto">
            ...
            <div className="text-sm text-center mt-3">
              ...
              voluptate rerum quidem eveniet, dolorum sint maxime?
              Exercitationem, eum? Veritatis voluptatibus odit repellendus hic?
            </div>
